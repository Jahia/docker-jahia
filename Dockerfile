...
RUN jar xvf /usr/local/tomcat/webapps/ROOT/WEB-INF/lib/jahia-impl-*.jar META-INF/MANIFEST.MF \
    && grep Implementation-Version META-INF/MANIFEST.MF | cut -f2 -d\ | cut -f1 -d- > version.txt \
